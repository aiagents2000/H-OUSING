...
import { CheckCircle2, Circle, Clock, XCircle, ImageIcon } from "lucide-react";
...
export function RequestDetailModal({
  ...
  const photoUrl = useQuery(
    ...
    request?.photoStorageId ? { storageId: request.photoStorageId } : "skip"
  );
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto rounded-xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {t("common.room")} {request.roomNumber}
                {request.building} &middot;{" "}
        ...
        <div className="space-y-4 mt-2">
          ...
          {photoUrl && (
            <div>
              <h4 className="text-sm font-semibold mb-2">{t("common.photo")}</h4>
              <img
                src={photoUrl}
                alt="Request photo"
                    ...
                    <div>
                      ...
                      {step.time && (
                        <p className="text-xs text-muted-foreground">
                          {format(new Date(step.time), "dd/MM/yyyy HH:mm", {
                            locale: dateLocale,
                          })}
                        </p>
                      )}
